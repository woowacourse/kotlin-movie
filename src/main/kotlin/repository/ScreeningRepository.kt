...
class ScreeningRepository(
    ...
    fun findBy(movie: Movie, date: LocalDate): Screenings =
        Screenings(screenings.filter { it.movie == movie && it.showDate == date })
