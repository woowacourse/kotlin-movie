object Message {
    ...
    const val IS_NOT_DIGIT = "숫자만 입력 가능합니다."
    const val SEAT_GROUP = "좌석 배치도"
    const val INVALID_SEAT = "해당 좌석은 예매할 수 없습니다."
    const val EMPTY_MOVIE_NAME = "영화 이름은 비어있을 수 없습니다."
    const val INVALID_YES_OR_NO = "Y, N만 입력 가능합니다."
    const val IS_NEGATIVE_NUMBER = "0 이상만 입력 가능합니다."
    const val IS_NOT_NUMBER = "숫자만 입력 가능합니다."
