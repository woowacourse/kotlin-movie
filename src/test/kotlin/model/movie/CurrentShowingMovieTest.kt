...
class CurrentShowingMovieTest {
    ...
    fun `영화 목록에 포함된 영화 제목을 입력하면 영화를 반환한다`() {
        ...
        assertThat(currentShowingMovie.findByName("영화1")).isEqualTo(movie1)
    }
    ...
    fun `영화 목록에 포함되어 있지 않은 영화 제목을 입력하면 null을 반환한다`() {
        ...
        assertThat(currentShowingMovie.findByName("영화3")).isNull()
    }
}
